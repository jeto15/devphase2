        ...
        $.ajax({
            ...
            success: function(response)
            {
                ...
                for (const row_index in res.result) {
                    ...
                    htmlRow+=' <td>'+ row.totalQty +'</td>'; 
                    htmlRow+=' <td>'+ row.Name +'</td>';
                    htmlRow+=' <td>'+ row.Brand +'</td>';
                    htmlRow+=' <td>'+ row.DosageForm +'</td>';
                    htmlRow+=' <td>'+ row.Strength +'</td>';
                    htmlRow+=' <td>'+ row.Manufacturer +'</td>';
                    htmlRow+=' <td>'+ row.Description +'</td>';
                    htmlRow+=' </tr>';
